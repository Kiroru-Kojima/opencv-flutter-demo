...
import 'opencv_channel_platform_interface.dart';

/// An implementation of [OpencvChannelPlatform] that uses method channels.
class MethodChannelOpencvChannel extends OpencvChannelPlatform {
  /// The method channel used to interact with the native platform.
  @visibleForTesting
  final methodChannel = const MethodChannel('opencv_channel');
